                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-6">
                                    <div className="product__item">
                                        <div
                                            ...
                                            data-setbg="https://picsum.photos/id/237/200/200">
                                            <div className="label new">New</div>
                                            <ul className="product__hover">
                                                <li>
                                                    <a href="https://picsum.photos/id/237/200/200" className="image-popup"><CgArrowsExpandRight size={23} /></a>
                                                </li>
                                                <li>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="product__item">
                                        <div
                                            className="product__item__pic set-bg"
                                            data-setbg="https://picsum.photos/seed/picsum/200/300"
                                        >
                                            <ul className="product__hover">
                                                <li>
                                                    <a href="https://picsum.photos/seed/picsum/200/300" className="image-popup">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="product__item">
                                        <div
                                            className="product__item__pic set-bg"
                                            data-setbg="https://picsum.photos/200/200?grayscale"
                                        >
                                            <ul className="product__hover">
                                                <li>
                                                    <a href="https://picsum.photos/200/200?grayscale" className="image-popup">
                                                        <span className="arrow_expand" />
                                                    </a>
                                                </li>
                                                <li>
